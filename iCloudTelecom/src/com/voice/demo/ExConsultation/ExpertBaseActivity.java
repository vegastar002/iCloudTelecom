...
import com.voice.demo.group.utils.ThreadPoolManager;
...
public class ExpertBaseActivity extends GroupBaseActivity implements ExpertManagerHelper.onExpertManagerHelpListener{
    ...
    public static final String ACTION_EXPERT_MAIN = "com.voice.demo.Intent.VoiceIntent.ACTION_EXPERT_MAIN";
    public static final String ACTION_EXPERT_LIST_VIEW = "com.voice.demo.Intent.VoiceIntent.ACTION_EXPERT_LIST_VIEW";
    public static final String ACTION_EXPERT_ORDER = "com.voice.demo.Intent.VoiceIntent.ACTION_EXPERT_ORDER";
    public static final String ACTION_EXPERT_CONMUI = "com.voice.demo.Intent.VoiceIntent.ACTION_EXPERT_CONMUI";
    
    public static final String ACTION_EXPERT_DETAIL_VIEW = "com.voice.demo.Intent.VoiceIntent.ACTION_EXPERT_DETAIL_VIEW";
	...
	protected void doHandleExpertCallback(Message msg) {
		...
		Log4Util.i(VoiceHelper.DEMO_TAG, "What: " + what);
		switch (what) {
	...
	protected void onStart() {
		//LawerManagerHelper.getInstance().setOnLawerManagerHelpListener(this);
		super.onStart();
	}
	...
	protected void onPause() {
		//LawerManagerHelper.getInstance().setOnLawerManagerHelpListener(null);
		Log4Util.d(VoiceHelper.DEMO_TAG, "[LawerManagerHelper - listener] " + null);
		super.onPause();
	}
