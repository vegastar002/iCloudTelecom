			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				if (groupPosition == 0) {
					...
					if (mOnChangeViewListener != null) {
						...
						case 0:
							mOnChangeViewListener.onChangeView(View_Util.NewsFeed);
							break;
						...
						case 4:
							...
							break;
						case 5:
							mOnChangeViewListener.onChangeView(View_Util.Location);
							break;
						case 6:
...
//						mContext.startActivity(new Intent(mContext,	Settings.class));
					...
					case 1:
						Toast.makeText(mContext, "因无登录界面,所以暂时无操作", Toast.LENGTH_SHORT).show();
						break;
					}
				}
				return true;
