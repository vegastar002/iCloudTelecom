...
public class Message {
	...
	private ListView chat_displayList;
	...
	private void init() {
//		message = LayoutInflater.from(mContext).inflate(R.layout.message_message, null);
		message = LayoutInflater.from(mContext).inflate(R.layout.chat_list, null);
		View friend = LayoutInflater.from(mContext).inflate(R.layout.message_friend, null);
		View birthday = LayoutInflater.from(mContext).inflate(R.layout.message_birthday, null);
		mList.add(message);
		mList.add(friend);
		mList.add(birthday);
		...
		chat_displayList = (ListView) message.findViewById(R.id.contact_list);
	}
