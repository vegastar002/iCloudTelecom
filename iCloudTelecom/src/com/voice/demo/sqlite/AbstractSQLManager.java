...
public abstract class AbstractSQLManager {
	...
	public AbstractSQLManager() {
		openDatabase(BaseApplication.getInstance(), BaseApplication.getInstance().getVersionCode());
	}
	 ...
	 * @version 1.0.0
	 */
	static class CCPDBHelper extends SQLiteOpenHelper {
		static final String DATABASE_NAME = CCPConfig.VoIP_ID + "_ccp_demo.db";
		...
		static final String[] TABLE_NAME = { TABLES_NAME_IM_GROUP_INFO,
