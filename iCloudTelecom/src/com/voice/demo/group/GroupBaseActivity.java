 ...
 */
public class GroupBaseActivity extends CCPBaseActivity implements RestGroupManagerHelper.onRestGroupManagerHelpListener , ThreadPoolManager.OnTaskDoingLinstener{

	public static final int TASK_KEY_DEL_MESSAGE = 11;
	
	public static final int WHAT_SHOW_PROGRESS = 0x101A;
	public static final int WHAT_CLOSE_PROGRESS = 0x101B;
	//public static final String INTENT_NEW_GROUP = "com.voice.demo.Intent.VoiceIntent.ACTION_NEW_GROUP";
	...
	private final android.os.Handler handler = new android.os.Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if(msg.what == WHAT_SHOW_PROGRESS) {
				...
				pDialog.show();
				Log4Util.d(VoiceHelper.DEMO_TAG, "dialog  show");
			} else if (msg.what == WHAT_CLOSE_PROGRESS) {
				if(pDialog != null ) {
					pDialog.dismiss();
					pDialog = null;
				}
				Log4Util.d(VoiceHelper.DEMO_TAG, "dialog  dismiss");
			} else {
